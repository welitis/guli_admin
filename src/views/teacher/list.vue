<template>
  <div class="app-container">讲师列表
    <!--查询表单-->
    <el-form ref="ruleForm" :inline="true" :model="searchObj" class="demo-form-inline">
      <el-form-item label="讲师名" prop="name">
        <el-input v-model="searchObj.name" placeholder="讲师名"/>
      </el-form-item>

      <el-form-item label="讲师名" prop="level">
      ...
      <el-button type="default" @click="resetForm('ruleForm')">清空</el-button>
    </el-form>
    <!-- 表格 -->
    <el-table
